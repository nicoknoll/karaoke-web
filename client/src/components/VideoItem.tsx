...
const VideoItem = ({ video, selected, ...props }: any) => {
    const { title, thumbnail_url: thumbnailUrl, duration, id } = video;
    ...
    return (
        ...
        >
            <div className="relative rounded-lg">
                ...
                <img src={thumbnailUrl || "/placeholder.png"} alt="" className="h-32 w-32 rounded-lg object-cover" />
            </div>
            ...
            <div className="flex flex-1 flex-col gap-5">
                ...
                <p className="flex gap-8 text-4xl font-medium text-neutral-600">
                    ...
                    {duration && <span className="flex items-center gap-3">
                        <span className="text-3xl">
